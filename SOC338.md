...
So it looks like the sender's SMTP domain is ***windows-update[.]site***. It also has a link that directs the user to ***www[.]windows-update[.]site*** . Let's check it on VirusTotal.
...
- Are there any attachments?
  > No, it contains a malicious link
