...
It looks like this is a phishing email sent by ***update@windows-update[.]site*** to user ***dylan@letsdefend[.]io*** claiming a free windows 11 pro update. It also looks like this email contains a link that could direct to a malicious website which is used to deliver Lumma Stealer malware.
...
### Playbook
LetsDefend provides us with a playbook to follow and investigate the alert correctly.
![Playbook](screenshots/SOC338/SOC338-1.png)


When you receive an alert about a phishing email there are multiple things to note.
1. Sender's E-mail & Domain
2. Recipient Address
3. Are there any attachments or links? If yes, are they malicious or not?
...
So it looks like the sender's SMTP domain is ***windows-update[.]site***. The email also contains two buttons, each linking to ***www[.]windows-update[.]site***. Let's check it on VirusTotal.

![virustotal_website](screenshots/SOC338/SOC338-5.png)

11 out of 94 security vendors flagged it as malicious, indicating high risk.
...
- Are there any attachments?
  > No, the email contains a malicious link.

Let's continue the playbook!

![playbook-attachment](screenshots/SOC338/SOC338-3.png)

We confirmed that the email has a link directing to a malicious website.
...
Looking at the terminal history, PowerShell was used to download a file from the URL ***hxxps[://]overcoatpassably[.]shop/Z8UZbPyVpGfdRS/maloy[.]mp4***, which was then executed via mshta.exe (a legitimate Windows utility often abused to run malicious scripts).
