...
When you receive an alert about a phishing email there's multiple things to consider
...
![action](screenshots/SOC338/SOC338-7.png)
...
Looking at the terminal history, the micrsoft utility PowerShell was used to download a file and that file was executed by another utility(mshta.exe) which allows execution of HTML applications

Let's take another look at the Processes section
