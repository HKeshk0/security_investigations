...
It looks like this is a phishing email sent by ***update@windows-update[.]site*** to user ***dylan@letsdefend[.]io*** claiming a free windows 11 pro update. It also looks like this email contains a link that could direct to a malicious website which has downloadable Lumma Stealer malware.
